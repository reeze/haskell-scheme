...
defineVal :: Env -> String -> LispVal -> IOThrowsError LispVal
defineVal envRef var value = do
...
eval env (List [Atom "define", Atom var, form]) = eval env form >>= defineVal env var
